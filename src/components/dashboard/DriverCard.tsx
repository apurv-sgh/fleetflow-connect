...
const tierConfig = {
  1: { label: "Reserved Pool", variant: "tier1" as const, color: "text-success" },
  2: { label: "Priority", variant: "tier2" as const, color: "text-info" },
  3: { label: "Standard", variant: "tier3" as const, color: "text-warning" },
  4: { label: "Probation", variant: "tier4" as const, color: "text-destructive" },
};
