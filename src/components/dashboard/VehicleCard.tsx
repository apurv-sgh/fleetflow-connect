...
export interface Vehicle {
  ...
  status: "available" | "in-use" | "maintenance" | "reserved" | "retired";
  pool: "reserved" | "non-reserved";
  assignedDriverId?: string;
  assignedDriverName?: string;
  assignedHOGName?: string;
