...
import DriverCard, { Driver } from "@/components/dashboard/DriverCard";
import VehicleCard, { Vehicle } from "@/components/dashboard/VehicleCard";
...
const AdminDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "bookings" | "drivers" | "vehicles" | "tracking">("overview");
